...
const EditEvent = () => {
  ...
  const updateEvent = async (e) => {
    ...
    try {
      await axiosJWT.patch(
        `http://localhost:4025/updateevent/${id}`,
        {
          study_id,
          site_id,
          subject_id,
  ...
  const getEventById = async () => {
    const response = await axiosJWT.get(
      `http://localhost:4025/getevent/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    setCat(response.data.event_category);
    setDesc(response.data.event_desc);
    setRes(response.data.event_res);
    setCritic(response.data.event_critic);
    setClosed(response.data.event_closed);
  };
            ...
            <div className="control">
              <div className="select is-fullwidth">
                ...
                >
                  ...
                  <option value="Serious Adverse Event">
